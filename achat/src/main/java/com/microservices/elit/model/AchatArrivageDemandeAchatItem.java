...
/**
 * The persistent class for the achat_arrivage_demande_achat_item database table.
 * 
 */
@Entity
@Table(name="achat_arrivage_demande_achat_item")
@NamedQuery(name="AchatArrivageDemandeAchatItem.findAll", query="SELECT a FROM AchatArrivageDemandeAchatItem a")
public class AchatArrivageDemandeAchatItem implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private AchatArrivageDemandeAchatItemPK id;
	...
	//bi-directional many-to-one association to DemandeLigne
	@ManyToOne
	@JoinColumn(name="id_demande_achat_item", insertable=false, updatable=false)
	private DemandeLigne demandeLigne;

	public AchatArrivageDemandeAchatItem() {
	}

	public AchatArrivageDemandeAchatItemPK getId() {
		return this.id;
	}

	public void setId(AchatArrivageDemandeAchatItemPK id) {
		this.id = id;
	}
	...
	public DemandeLigne getDemandeLigne() {
		return this.demandeLigne;
	}

	public void setDemandeLigne(DemandeLigne demandeLigne) {
		this.demandeLigne = demandeLigne;
	}
