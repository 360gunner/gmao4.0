...
/**
 * The persistent class for the achat_arrivage_facture_frais_item database table.
 * 
 */
@Entity
@Table(name="achat_arrivage_facture_frais_item")
@NamedQuery(name="AchatArrivageFactureFraisItem.findAll", query="SELECT a FROM AchatArrivageFactureFraisItem a")
public class AchatArrivageFactureFraisItem implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name="id_arrivage_facture_frais", insertable=false, updatable=false)
	private AchatArrivageFactureFrai achatArrivageFactureFrai;
	...
	public AchatArrivageFactureFraisItem() {
	}
	...
	public AchatArrivageFactureFrai getAchatArrivageFactureFrai() {
		return this.achatArrivageFactureFrai;
	}

	public void setAchatArrivageFactureFrai(AchatArrivageFactureFrai achatArrivageFactureFrai) {
		this.achatArrivageFactureFrai = achatArrivageFactureFrai;
	}
