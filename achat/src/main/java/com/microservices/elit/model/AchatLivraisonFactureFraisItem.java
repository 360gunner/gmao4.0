...
/**
 * The persistent class for the achat_livraison_facture_frais_item database table.
 * 
 */
@Entity
@Table(name="achat_livraison_facture_frais_item")
@NamedQuery(name="AchatLivraisonFactureFraisItem.findAll", query="SELECT a FROM AchatLivraisonFactureFraisItem a")
public class AchatLivraisonFactureFraisItem implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name="id_livraison_facture_frais", insertable=false, updatable=false)
	private AchatLivraisonFactureFrai achatLivraisonFactureFrai;

	public AchatLivraisonFactureFraisItem() {
	}
	...
	public AchatLivraisonFactureFrai getAchatLivraisonFactureFrai() {
		return this.achatLivraisonFactureFrai;
	}

	public void setAchatLivraisonFactureFrai(AchatLivraisonFactureFrai achatLivraisonFactureFrai) {
		this.achatLivraisonFactureFrai = achatLivraisonFactureFrai;
	}
