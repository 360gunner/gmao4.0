...
/**
 * The primary key class for the visibilite_unite_engagement database table.
 * 
 */
@Embeddable
public class VisibiliteUniteEngagementPK implements Serializable {
	...
	public VisibiliteUniteEngagementPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VisibiliteUniteEngagementPK)) {
			return false;
		}
		VisibiliteUniteEngagementPK castOther = (VisibiliteUniteEngagementPK)other;
		return 
