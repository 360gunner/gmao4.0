...
/**
 * The persistent class for the achat_arrivage_facture_frais database table.
 * 
 */
@Entity
@Table(name="achat_arrivage_facture_frais")
@NamedQuery(name="AchatArrivageFactureFrai.findAll", query="SELECT a FROM AchatArrivageFactureFrai a")
public class AchatArrivageFactureFrai implements Serializable {
	...
	@OneToMany(mappedBy="achatArrivageFactureFrai")
	private List<AchatArrivageFactureFraisItem> achatArrivageFactureFraisItems;

	public AchatArrivageFactureFrai() {
	}
	...
	public AchatArrivageFactureFraisItem addAchatArrivageFactureFraisItem(AchatArrivageFactureFraisItem achatArrivageFactureFraisItem) {
		...
		achatArrivageFactureFraisItem.setAchatArrivageFactureFrai(this);
	...
	public AchatArrivageFactureFraisItem removeAchatArrivageFactureFraisItem(AchatArrivageFactureFraisItem achatArrivageFactureFraisItem) {
		...
		achatArrivageFactureFraisItem.setAchatArrivageFactureFrai(null);
