...
/**
 * The persistent class for the achat_engagement_centre_charge database table.
 * 
 */
@Entity
@Table(name="achat_engagement_centre_charge")
@NamedQuery(name="AchatEngagementCentreCharge.findAll", query="SELECT a FROM AchatEngagementCentreCharge a")
public class AchatEngagementCentreCharge implements Serializable {
	...
	public AchatEngagementCentreCharge() {
	}
