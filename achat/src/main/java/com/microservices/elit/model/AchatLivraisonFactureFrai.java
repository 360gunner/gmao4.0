...
/**
 * The persistent class for the achat_livraison_facture_frais database table.
 * 
 */
@Entity
@Table(name="achat_livraison_facture_frais")
@NamedQuery(name="AchatLivraisonFactureFrai.findAll", query="SELECT a FROM AchatLivraisonFactureFrai a")
public class AchatLivraisonFactureFrai implements Serializable {
	...
	@OneToMany(mappedBy="achatLivraisonFactureFrai")
	private List<AchatLivraisonFactureFraisItem> achatLivraisonFactureFraisItems;

	public AchatLivraisonFactureFrai() {
	}
	...
	public AchatLivraisonFactureFraisItem addAchatLivraisonFactureFraisItem(AchatLivraisonFactureFraisItem achatLivraisonFactureFraisItem) {
		...
		achatLivraisonFactureFraisItem.setAchatLivraisonFactureFrai(this);
	...
	public AchatLivraisonFactureFraisItem removeAchatLivraisonFactureFraisItem(AchatLivraisonFactureFraisItem achatLivraisonFactureFraisItem) {
		...
		achatLivraisonFactureFraisItem.setAchatLivraisonFactureFrai(null);
